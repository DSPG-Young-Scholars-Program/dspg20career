...
![](/findings/results-section-clustering_files/Fig3.png){width=100% height=800px}
...
![](/findings/results-section-clustering_files/Fig4.png){width=80% height=300px}
...
![](/findings/results-section-clustering_files/Fig5.png){width=100% height=850px; margin-left: 50px; margin-right: 50px}
$$\text{Fig 5. Type 3 Clusters}$$

![](/findings/results-section-clustering_files/Fig6.png){width=80% height=300px}
...
![](/findings/results-section-clustering_files/Fig7.png){width=100% height=500px}
...
ggplot(cluster_count, aes(x = cluster, y = N, fill = N))+
  ...
  scale_fill_continuous(low = "white", high=uva_color_palette[9])+
  theme_classic()+
