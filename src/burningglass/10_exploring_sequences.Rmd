...
# Sequential association ruleA rule subseq1→subseq2such that1Has a minimal support2When subseq1occurs, it is most often followed by subseq2Extracted from frequent sequences.
...
p <- ggplot() + 
  ...
  scale_y_continuous(name = "Share of careers in a job state") +
  xlim(0,10) +
  scale_fill_manual(values = c("#CBBEB5", uva_color_palette[1], uva_color_palette[2],uva_color_palette[4],  uva_color_palette[6], uva_color_palette[9], "purple", "#CBBEB5", "#CBBEB5"), labels = c("Missing zone", "Zone 1", "Zone 2", "Zone 3", "Zone 4", "Zone 5", "Transitional unemployed", "Unemployed", "Unemployed/Exit")) +
  xlab("Year of career") +
  labs(title = "Job states over time for first ten years after veteran's last military job",
       fill = "Job state",
       caption = "Data: BGT Resumes") +
  theme_classic() +
  theme(legend.position = "bottom")
