...
# load packages 
for (pkg in c("tidyverse",  "data.table", "R.utils",  "cowplot", "maditr", "stringr", "stringi", "mosaic", "dplyr", "ggplot2", "lubridate", "readxl", "gt")) {
...
vet_edu <- table(bg_full$veteran, bg_full$degree_highest)%>%
  as.data.frame()%>%
